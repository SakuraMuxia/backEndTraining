...
public class SwTelCardServ extends ViewBaseServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // 新建dao
        SwDao swDao = new SwDaoImpl();
        List<SwCard> Cards = swDao.getSwTelCards();
        Integer totals = swDao.getSwTelCardNum();
        ...
        req.setAttribute("cardType","开关电信卡");
        processTemplate("swtel",req,resp);
    }
}
