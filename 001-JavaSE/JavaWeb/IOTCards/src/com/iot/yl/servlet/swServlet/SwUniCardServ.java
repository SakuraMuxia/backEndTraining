...
public class SwUniCardServ extends ViewBaseServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // 新建dao
        SwDao swDao = new SwDaoImpl();
        // 执行dao操作
        List<SwCard> Cards = swDao.getSwUniCards();
        Integer totals = swDao.getSwUniCardNum();
        ...
        req.setAttribute("cardType","开关联通卡");
        processTemplate("swuni",req,resp);
    }
}
